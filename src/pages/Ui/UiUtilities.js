...
const UiUtilities = () => {
  document.title = "Utilities | verticalsols - React Admin & Dashboard Template"
  return (
    <React.Fragment>
              ...
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    ...
                    <code>--bs-border-opacity</code> via custom styles or inline
                    styles.
                  </p>
                  <div className="d-flex flex-wrap gap-2">
              ...
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    ...
                    corners. Sizes range from <code> 0</code> to <code> 3</code>
                    , and can be configured<code> 4</code> & <code> 5</code> by
