...
const UiAlert = () => {
  document.title = "Alerts | verticalsols - React Admin & Dashboard Template"
  return (
    <React.Fragment>
              ...
              <Card>
                <CardBody>
                  ...
                  <div className="">
                    ...
                    <Alert
                      color="danger"
                      className="bg-danger text-white mb-0 border-0"
                      role="alert"
                    >
                      <strong>Oh snap!</strong> Change a few things up and try
                      submitting again.
              ...
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    Alerts are available for any length of text, as well as an
                    optional dismiss button. For proper styling, use one of the
                    four <strong>required</strong> contextual classes.
                  </p>
