...
const UiModal = () => {
  ...
  document.title = "Modals | verticalsols - React Admin & Dashboard Template"
  return (
    <React.Fragment>
                  ...
                  <Row>
                    ...
                    <Col sm={6} md={4} xl={3}>
                      <div className="my-4 text-center">
                        ...
                        <Button onClick={tog_xlarge} color="primary">
                          {" "}
                          Extra large modal{" "}
                        </Button>
                        <Modal
                    ...
                    <Col sm={6} md={4} xl={3}>
                      <div className="my-4 text-center">
                        ...
                        <Button color="primary" onClick={tog_large}>
                          {" "}
                          Large modal{" "}
                        </Button>
                      </div>
                    ...
                    <Col sm={6} md={4} xl={3}>
                      <div className="my-4 text-center">
                        ...
                        <Button color="primary" onClick={tog_small}>
                          {" "}
                          Small modal{" "}
                        </Button>
                      </div>
                    ...
                    <Col sm={6} md={4} xl={3}>
                      ...
                      <Modal
                        ...
                        scrollable
                      >
                        <ModalHeader className="mt-0" toggle={tog_scroll}>
                          Scrollable Modal
                        </ModalHeader>
                        <ModalBody>
                          <p>
                    ...
                    <Col sm={6} md={4} xl={3}>
                      ...
                      >
                        <ModalHeader className="mt-0" toggle={tog_fullscreen}>
                          Fullscreen Modal
                        </ModalHeader>
                        <ModalBody>
                          <h5>Overflowing text to show scroll behavior</h5>
