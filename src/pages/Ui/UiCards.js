...
const UiCards = () => {
  document.title = "Cards | verticalsols - React Admin & Dashboard Template"
  return (
    <React.Fragment>
          ...
          <Row>
            ...
            <Col md={6} lg={6} xl={3}>
              <Card>
                ...
                <CardImg className="img-fluid" src={img4} alt="verticalsols" />
                <CardBody>
                  <p className="card-text">
                    Some quick example text to build on the card title and make
                    up the bulk of the card's content.
          ...
          <Row>
            ...
            <Col lg={4}>
              <Card className="text-white">
                <CardImg className="img-fluid" src={img6} alt="verticalsols" />
                <CardImgOverlay>
